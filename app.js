...
/* === Default quests === */
const QUESTS = [
  {id:1,title:"   ݧѧӧߧѧ   ٧ѧէѧ  ",xp:25,icon:" 7 3"},
  {id:2,title:"   ڧ ѧ   20  ާڧߧ  ",xp:10,icon:" 9 2"},
  {id:3,title:"10 000   ѧԧ  ",xp:10,icon:" 0 8"},
  {id:4,title:"        30  ާڧ ",xp:15,icon:" 9 4"},
  {id:5,title:"    קҧ  45  ާڧ ",xp:20,icon:" 9 5"}
];
...
function renderQuests(){
  ...
  state.quests.forEach(q=>{
    ...
    row.innerHTML=`
      ...
      <div class="q-meta muted"> 9 7     ڧ : ${q.streak}</div>
    `;
    const btn=document.createElement("button");
    btn.className="q-btn";
    btn.textContent=q.doneToday?"      ݧߧ֧ߧ ":"    ާ֧ ڧ  ";
...
function renderProfileMini(){
  $("#profNameView").textContent=state.profile.name||"   ֧   ڧާ֧ߧ ";
